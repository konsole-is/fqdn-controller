...
import (
	...
	fqdnv1alpha1 "github.com/konsole-is/fqdn-controller/api/v1alpha1"
	"github.com/konsole-is/fqdn-controller/internal/controller"
	webhookv1alpha1 "github.com/konsole-is/fqdn-controller/internal/webhook/v1alpha1"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "de9670af.konsole.is",
	...
	if os.Getenv("ENABLE_WEBHOOKS") != "false" {
		if err := webhookv1alpha1.SetupNetworkPolicyWebhookWithManager(mgr); err != nil {
